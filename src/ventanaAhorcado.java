...
public class ventanaAhorcado extends javax.swing.JFrame {
    ...
    //esto es una variable de instancia, es decir una variable que vamos a usar en tooooodo el programa. Si no haríamos un private
    int numeroFallos = 0;
    /**
    ...
    private void dibujaImagen(int numeroFallos){
        ...
        switch(numeroFallos){
            case 0: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_0.png"); break;
            case 1: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_1.png"); break;
            case 2: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_2.png"); break;
            case 3: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_3.png"); break;
            case 4: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_4.png"); break;
            case 5: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_5.png"); break;
            default: nombreImagen = getClass().getResource("/codigo/imagenes/ahorcado_fin.png"); break;
           
        }
        
        miImagen = new ImageIcon(new ImageIcon(nombreImagen).getImage().getScaledInstance(ancho, alto, Image.SCALE_DEFAULT));
        //esto sirve para cargar la imagen
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton20, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 528, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(45, 45, 45)
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 328, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void chequeaLetra(String letra){
        //como todas las letras son mayusculas, hacemos que solo compruebe mayúsculas
       letra = letra.toUpperCase();
       StringBuilder palabraConGuiones = new StringBuilder(jLabel1.getText());
    
       // palabraoculta, está la letra que he pulsado?
       if (palabraOculta.contains(letra)){
           //esto me devolverá la longitud en caracteres de la palabra oculta. Si la i< 5 (en este caso) se ejecutará eso.La i empieza en 0 y acabará en 4
           //
           ...
           //para cambiar lo que hay en la pantalla pones settext
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        //Que boton ha generado el evento (get source)
        chequeaBoton((JButton)evt.getSource());
